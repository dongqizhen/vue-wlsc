...
(function() {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        ,
        serverUrl: window.UEDITOR_COMMIT_URL + "?callUrl=" + window.UEDITOR_CALLBACK_URL
        ...
        toolbars: [
                ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                    ...
                    'superscript', 'subscript', '|', 'forecolor',
                    'backcolor', '|', 'removeformat', '|', 'insertorderedlist', 'insertunorderedlist', '|',
                    'selectall', 'cleardoc',
                    'paragraph', 'fontfamily', 'fontsize', '|',
                    'justifyleft', 'justifycenter', 'justifyright', '|', 'link', 'unlink', '|',
                    'simpleupload', 'insertimage', 'emotion', 'insertvideo', '|', 'map', '|',
                    'horizontal', 'print', 'preview', 'drafts', 'attachment'
                ]
            ]
